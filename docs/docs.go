...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_InSleepMode_golang-todoapp_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
                    "500": {
    ...
    "definitions": {
        "github_com_InSleepMode_golang-todoapp_internal_core_transport_http_response.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string",
        ...
        "github_com_InSleepMode_golang-todoapp_internal_core_transport_http_types.Nullable-bool": {
            "type": "object",
            "properties": {
                "set": {
                    "type": "boolean"
        ...
        "github_com_InSleepMode_golang-todoapp_internal_core_transport_http_types.Nullable-string": {
            "type": "object",
            "properties": {
                "set": {
                    "type": "boolean"
        ...
        "internal_features_tasks_transport_http.CreateTaskResponse": {
            ...
            "properties": {
                ...
                "description": {
                    "type": "string",
                    "example": "Do homework until midnight"
                },
                "id": {
                    "type": "integer",
                    "example": 15
        ...
        "internal_features_tasks_transport_http.PatchTaskRequest": {
            ...
            "properties": {
                "completed": {
                    "$ref": "#/definitions/github_com_InSleepMode_golang-todoapp_internal_core_transport_http_types.Nullable-bool"
                },
                "description": {
                    "$ref": "#/definitions/github_com_InSleepMode_golang-todoapp_internal_core_transport_http_types.Nullable-string"
                },
                "title": {
                    "$ref": "#/definitions/github_com_InSleepMode_golang-todoapp_internal_core_transport_http_types.Nullable-string"
                }
