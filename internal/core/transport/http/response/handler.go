...
import (
	...
	core_errors "github.com/InSleepMode/golang-todoapp/internal/core/errors"
...
func (h *HTTPResponseHandler) HTMLResponse(html []byte) {
	...
	h.rw.Header().Set("Content-Type", "test/html; charset=utf-8")
...
func (h *HTTPResponseHandler) PanicResponse(p any, msg string) {
	...
	h.log.Error(msg, zap.Error(err)) //logging appeared panic
